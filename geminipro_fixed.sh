...
echo "Creating src/components/business-solutions/View.tsx..."
cat << 'END_OF_FILE_CONTENT' > "src/components/business-solutions/View.tsx"
...
END_OF_FILE_CONTENT
echo "Creating src/components/business-solutions/index.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/business-solutions/index.ts"
...
END_OF_FILE_CONTENT
echo "Creating src/components/business-solutions/schema.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/business-solutions/schema.ts"
import { z } from 'zod';
...
END_OF_FILE_CONTENT
echo "Creating src/components/business-solutions/types.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/business-solutions/types.ts"
import { z } from 'zod';
...
END_OF_FILE_CONTENT
mkdir -p "src/components/cta-band"
echo "Creating src/components/cta-band/View.tsx..."
cat << 'END_OF_FILE_CONTENT' > "src/components/cta-band/View.tsx"
import React from 'react';
...
END_OF_FILE_CONTENT
echo "Creating src/components/cta-band/index.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/cta-band/index.ts"
export { CtaBandComponent } from './View';
export { CtaBandSchema } from './schema';
export type { CtaBandData, CtaBandSettings } from './types';

END_OF_FILE_CONTENT
echo "Creating src/components/cta-band/schema.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/cta-band/schema.ts"
import { z } from 'zod';
...
END_OF_FILE_CONTENT
echo "Creating src/components/cta-band/types.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/cta-band/types.ts"
import { z } from 'zod';
import { BaseSectionSettingsSchema } from '@olonjs/core';
...
END_OF_FILE_CONTENT
mkdir -p "src/components/hero-bento"
echo "Creating src/components/hero-bento/View.tsx..."
cat << 'END_OF_FILE_CONTENT' > "src/components/hero-bento/View.tsx"
import React from 'react';
...
END_OF_FILE_CONTENT
echo "Creating src/components/hero-bento/index.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/hero-bento/index.ts"
...
END_OF_FILE_CONTENT
echo "Creating src/components/hero-bento/schema.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/hero-bento/schema.ts"
import { z } from 'zod';
import { BaseSectionData, CtaSchema } from '@olonjs/core';
...
END_OF_FILE_CONTENT
echo "Creating src/components/hero-bento/types.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/hero-bento/types.ts"
import { z } from 'zod';
import { BaseSectionSettingsSchema } from '@olonjs/core';
...
END_OF_FILE_CONTENT
mkdir -p "src/components/reviews-slider"
echo "Creating src/components/reviews-slider/View.tsx..."
cat << 'END_OF_FILE_CONTENT' > "src/components/reviews-slider/View.tsx"
import React from 'react';
...
END_OF_FILE_CONTENT
echo "Creating src/components/reviews-slider/index.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/reviews-slider/index.ts"
...
END_OF_FILE_CONTENT
echo "Creating src/components/reviews-slider/schema.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/reviews-slider/schema.ts"
import { z } from 'zod';
import { BaseSectionData, BaseArrayItem } from '@olonjs/core';
...
END_OF_FILE_CONTENT
echo "Creating src/components/reviews-slider/types.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/reviews-slider/types.ts"
import { z } from 'zod';
import { BaseSectionSettingsSchema } from '@olonjs/core';
...
echo "Creating src/components/services-grid/View.tsx..."
cat << 'END_OF_FILE_CONTENT' > "src/components/services-grid/View.tsx"
import React from 'react';
...
END_OF_FILE_CONTENT
echo "Creating src/components/services-grid/index.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/services-grid/index.ts"
...
END_OF_FILE_CONTENT
echo "Creating src/components/services-grid/schema.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/services-grid/schema.ts"
import { z } from 'zod';
import { BaseSectionData, BaseArrayItem } from '@olonjs/core';
...
END_OF_FILE_CONTENT
echo "Creating src/components/services-grid/types.ts..."
cat << 'END_OF_FILE_CONTENT' > "src/components/services-grid/types.ts"
import { z } from 'zod';
import { BaseSectionSettingsSchema } from '@olonjs/core';
